...
establishing coding standards, and developing junior engineers into strong contributors.`,
			responsibilities: "Design system architecture, conduct code reviews, mentor junior engineers, collaborate on technical roadmap, and establish best practices for the engineering team.",
			sharepointUrl: "https://sharepoint.local/job-specifications/senior-software-engineer",
...
supportive environment with hands-on guidance.`,
			responsibilities: "Implement new features, write unit tests, participate in code reviews, debug issues, and contribute to technical documentation.",
			sharepointUrl: "https://sharepoint.local/job-specifications/junior-software-engineer",
...
devices and browsers while delighting our users.`,
			responsibilities: "Develop UI components, optimize performance, ensure cross-browser compatibility, collaborate with designers and backend engineers, and maintain component libraries.",
			sharepointUrl: "https://sharepoint.local/job-specifications/frontend-engineer",
			numberOfOpenPositions: 2,
		},
		{
...
system reliability and security for our growing user base.`,
			responsibilities: "Design APIs, implement database optimizations, ensure system reliability, handle distributed systems challenges, and implement security best practices.",
			sharepointUrl: "https://sharepoint.local/job-specifications/backend-engineer",
			numberOfOpenPositions: 2,
		},
		{
...
to ensure seamless integration and optimal performance.`,
			responsibilities: "Implement full features, optimize performance, manage databases, deploy to production, collaborate across teams, and participate in architecture discussions.",
			sharepointUrl: "https://sharepoint.local/job-specifications/full-stack-engineer",
...
to enable rapid and safe deployments.`,
			responsibilities: "Manage cloud infrastructure, implement monitoring and logging, maintain CI/CD pipelines, respond to incidents, and optimize system performance.",
			sharepointUrl: "https://sharepoint.local/job-specifications/devops-engineer",
			numberOfOpenPositions: 1,
		},
		{
...
adopt cloud best practices.`,
			responsibilities: "Design cloud solutions, evaluate cloud services, implement disaster recovery strategies, optimize costs, and mentor engineering teams on cloud best practices.",
			sharepointUrl: "https://sharepoint.local/job-specifications/cloud-architect",
			numberOfOpenPositions: 1,
		},
		{
...
data into intelligent features.`,
			responsibilities: "Develop predictive models, analyze recruitment trends, create data visualizations, present insights to stakeholders, and implement A/B testing frameworks.",
			sharepointUrl: "https://sharepoint.local/job-specifications/data-scientist",
			numberOfOpenPositions: 2,
		},
		{
...
and optimization.`,
			responsibilities: "Develop ML pipelines, optimize model performance, handle data preprocessing, conduct experiments, and deploy models to production.",
...
for all data consumers.`,
			responsibilities: "Design data architectures, build ETL pipelines, manage data quality, optimize data warehouse queries, and maintain data governance.",
			sharepointUrl: "https://sharepoint.local/job-specifications/data-engineer",
			numberOfOpenPositions: 1,
		},
		{
...
collaboration with engineering and design teams.`,
			responsibilities: "Define product strategy, prioritize features, conduct user research, manage stakeholder communications, and measure product metrics.",
			sharepointUrl: "https://sharepoint.local/job-specifications/product-manager",
			numberOfOpenPositions: 1,
		},
		{
...
engineering teams to bring designs to life.`,
			responsibilities: "Conduct user research, create wireframes and prototypes, design user interfaces, conduct usability testing, and maintain design systems.",
			sharepointUrl: "https://sharepoint.local/job-specifications/product-designer",
			numberOfOpenPositions: 2,
		},
		{
...
through evidence-based insights.`,
			responsibilities: "Plan and execute user research studies, analyze findings, create personas and journey maps, present insights, and advocate for user needs.",
			sharepointUrl: "https://sharepoint.local/job-specifications/ux-researcher",
			numberOfOpenPositions: 1,
		},
		{
...
for production releases.`,
			responsibilities: "Write test cases, execute manual and automated tests, report bugs, work with developers to resolve issues, and maintain test automation frameworks.",
...
technical planning.`,
			responsibilities: "Lead team initiatives, mentor engineers, make architectural decisions, handle technical escalations, and communicate with product teams.",
			sharepointUrl: "https://sharepoint.local/job-specifications/technical-lead",
			numberOfOpenPositions: 1,
		},
		{
...
initiatives with business goals.`,
			responsibilities: "Recruit and hire engineers, manage team performance, provide career development, handle team dynamics, and align engineering with business goals.",
			sharepointUrl: "https://sharepoint.local/job-specifications/engineering-manager",
...
their processes.`,
			responsibilities: "Run daily standups and retrospectives, manage sprint planning, remove impediments, coach team on agile practices, and track metrics.",
...
feasibility and business value. Bridge the gap between customer requirements and technical implementation.`,
			responsibilities: "Understand customer requirements, design solutions, create architecture documentation, support implementation, and handle customer escalations.",
			sharepointUrl: "https://sharepoint.local/job-specifications/solutions-architect",
			numberOfOpenPositions: 1,
		},
		{
...
high availability.`,
			responsibilities: "Design systems architecture, manage system upgrades, implement redundancy, handle capacity planning, and optimize system performance.",
			sharepointUrl: "https://sharepoint.local/job-specifications/systems-engineer",
			numberOfOpenPositions: 1,
		},
		{
...
and system.`,
			responsibilities: "Implement security best practices, conduct security audits, manage access controls, respond to security incidents, and maintain compliance.",
			sharepointUrl: "https://sharepoint.local/job-specifications/security-engineer",
			numberOfOpenPositions: 1,
		},
		{
...
with database expertise.`,
			responsibilities: "Manage database infrastructure, optimize queries, implement backup and recovery, handle performance tuning, and ensure security compliance.",
			sharepointUrl: "https://sharepoint.local/job-specifications/database-admin",
			numberOfOpenPositions: 1,
		},
		{
...
on business metrics.`,
			responsibilities: "Gather requirements, conduct stakeholder interviews, analyze market data, create business cases, and support product decisions.",
			sharepointUrl: "https://sharepoint.local/job-specifications/business-analyst",
			numberOfOpenPositions: 1,
		},
		{
...
and reduce support burden.`,
			responsibilities: "Write user guides and API documentation, create tutorials and walkthroughs, maintain documentation systems, and update content regularly.",
			sharepointUrl: "https://sharepoint.local/job-specifications/technical-writer",
			numberOfOpenPositions: 1,
		},
		{
...
reliability. Own the release pipeline and help teams deliver features with confidence at scale.`,
			responsibilities: "Plan releases, coordinate across teams, manage deployment schedules, handle rollbacks, monitor production, and communicate with stakeholders.",
			sharepointUrl: "https://sharepoint.local/job-specifications/release-manager",
			numberOfOpenPositions: 1,
		},
	];
